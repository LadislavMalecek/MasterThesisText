...
% \newcolumntype{c1}{>{\begin{varwidth}{1cm}}c< {\end{varwidth}}} %M is for Maximal column
...
\DeclareMathOperator*{\mode}{mode}            % mode, most frequent value
...
\include{chapters/chap2_rs}
\include{chapters/chap3_fairness}
\include{chapters/chap4_related_work}
\include{chapters/chap5_datasets}
\include{chapters/chap6_our}
\include{chapters/chap7_experiments}
\include{chapters/chap8_conclusion}
...
\include{chapters/appendix_additional_results}
